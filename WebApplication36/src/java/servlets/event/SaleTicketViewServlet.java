 ...
 */
public class SaleTicketViewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String title = di.getEventTitleById(id);
        ArrayList<Tickets> tickets = tdi.getTicketsByAndConditionEvent_id(id);
